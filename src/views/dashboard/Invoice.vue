    ...
    <div class="page-invoices">
        <div class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li><router-link to="/dashboard/invoices" aria-current="True">Invoices</router-link></li>
        ...
        <div class="column is-12 mb-4" >
            <div class="box">
                <h3 class="is-size-4 mb-5">Client</h3>
                    ...
                    <p v-if="invoice.client_state">{{ invoice.client_state }}</p>
        ...
        <div class="column is-12 mb-4">
            <div class="box">
                ...
                <div class="columns">
                    ...
                    <div class="column is-6">
                         <p><strong>Our Reference</strong>: {{ invoice.sender_refer }}</p>
